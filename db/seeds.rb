...
:avatar => File.open('/home/amoedo/Imagens/sushi-kawaii.png', 'rb'),
...
Restaurant.create(name: "Giraffas", 
	...
	:avatar => File.open('/home/amoedo/Imagens/Giraffas.jpg', 'rb'),
...
Recipe.create(name: "Esfiha de Carne",
	...
	:avatar => File.open('/home/amoedo/Imagens/esfiha.jpg', 'rb'),
...
Recipe.create(name: "Lasanha com Ketchup",
	...
	:avatar => File.open('/home/amoedo/Imagens/lasanha.png', 'rb'),
...
Event.create(name: "Churrassic Park",
	...
	:avatar => File.open('/home/amoedo/Imagens/churrasic.jpg', 'rb'),
